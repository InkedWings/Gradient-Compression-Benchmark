...
class _CompSGD(Optimizer):
    ...
    def __init__(self, params, named_parameters, num_workers=1, compression=NoneCompression(),
        ...
        dups = _CompSGD.find_duplicates([k for k, _ in named_parameters])
        if len(dups) > 0:
...
def CompSGD(optimizer, named_parameters=None, num_workers=1,
